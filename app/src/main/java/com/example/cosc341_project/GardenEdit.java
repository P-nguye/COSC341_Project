...
public class GardenEdit extends AppCompatActivity {
    ...
    public void save(View view) {
        ...
        if(gardenName.getText().toString().isEmpty()){
            ...
            bundle.putBoolean("isDeleting", false);
    ...
    public void delete(View view){
        AlertDialog.Builder builder = new AlertDialog.Builder(GardenEdit.this);
        builder.setTitle("Warning!!!");
        builder.setMessage("Are you sure you want to delete " + gardenName.getText() + " garden?");
        builder.setPositiveButton("Yes", (dialog, which) -> {
            ...
            setResult(RESULT_OK, intent);
            finish();
            Toast.makeText(GardenEdit.this, "Garden Deleted", Toast.LENGTH_SHORT).show();
        });
